...
public:
  ...
  Statistic *qPopFast, *qPopFastCyc, *qPopLocal, *qPopLocalCyc, *qPopRemote, *qPopRemoteCyc, *qEmpty, *qEmptyCyc, *mkChunks, *pushedChunks, *popedChunks;
#else
  static Statistic *qPopFast, *qPopFastCyc, *qPopLocal, *qPopLocalCyc, *qPopRemote, *qPopRemoteCyc, *qEmpty, *qEmptyCyc, *mkChunks, *pushedChunks, *popedChunks;
  ...
  void init_qstats(std::string id = "(NULL)") {
    ...
    if (!qPopFast) {
      ...
      mkChunks = new Statistic("mkChunks", id);
      pushedChunks = new Statistic("pushedChunks", id);
      popedChunks = new Statistic("popedChunks", id);
#ifndef PER_CHUNK_STATS
    }
    statLock.unlock();
#endif
  ...
  ~ChunkedMaster() {
    ...
    if (qPopFast) {
      ...
      delete mkChunks; mkChunks = 0;
      delete pushedChunks; pushedChunks = 0;
      delete popedChunks; popedChunks = 0;
#ifndef PER_CHUNK_STATS
    }
    statLock.unlock();
#endif
...
template<typename T, template<typename, bool> class QT, bool Distributed, template<typename> class DistStore, bool IsStack, int ChunkSize, bool Concurrent>
Statistic* ChunkedMaster<T, QT, Distributed, DistStore, IsStack, ChunkSize, Concurrent>::mkChunks;


template<typename T, template<typename, bool> class QT, bool Distributed, template<typename> class DistStore, bool IsStack, int ChunkSize, bool Concurrent>
Statistic* ChunkedMaster<T, QT, Distributed, DistStore, IsStack, ChunkSize, Concurrent>::pushedChunks;

template<typename T, template<typename, bool> class QT, bool Distributed, template<typename> class DistStore, bool IsStack, int ChunkSize, bool Concurrent>
Statistic* ChunkedMaster<T, QT, Distributed, DistStore, IsStack, ChunkSize, Concurrent>::popedChunks;
#endif
