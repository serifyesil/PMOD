...
#find_path(PAPI_INCLUDE_DIRS papi.h ${PAPI_ROOT}  )
#find_library(PAPI_LIBRARY NAMES papi ${PAPI_ROOT} )

set(PAPI_INCLUDE_DIRS "${PAPI_ROOT}/include/")
set(PAPI_LIBRARY "${PAPI_ROOT}/lib/libpapi.so")
#find_library(PAPI_LIBRARY NAMES papi ${PAPI_ROOT})
find_library(PAPI_LIBRARIES NAMES rt PATH_SUFFIXES )
