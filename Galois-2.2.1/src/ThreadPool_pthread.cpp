...
#ifdef GEM5
//GEM5 doesn't like the system pthread library and uses it's own in the
//m5threads folder. It has limited functionality and semaphores aren't a part of
//it. Don't use semaphores when building for GEM5
class Semaphore {
  public:
    void release() {}
    void acquire() {}
